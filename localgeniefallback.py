...
AI100_MODEL = os.getenv("GENIEX_MODEL", "ai-hub-models/Qwen3-4B-Instruct-2507")
# ^ must match whatever you `geniex pull`ed. Confirmed available for Snapdragon X Elite
